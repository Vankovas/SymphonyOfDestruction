...
namespace CampingSpot
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Select braceletID FROM ticket tick join visitor vis ON(tick.userID = vis.userID) join hut_res camp ON(vis.userID = camp.userID) WHERE tick.userID = camp.userID;";
            ...
            if (yes == true)
            {
                ...
                string sql1 = "Select hutID FROM hut_res camp join visitor vis on (camp.userID = vis.userID) join ticket tick on( tick.userID = vis.userID) WHERE tick.braceletID = '" + tbBraceletId.Text.ToString() + "' ;";
                MySqlCommand command1 = new MySqlCommand(sql1, connection);
                MySqlDataReader reader1 = command1.ExecuteReader();
                while (reader1.Read())
                {
                    listBox1.Items.Add("Welcome! Your Hut is " + reader1[0] + " !!!");
            ...
            {
                listBox1.Items.Clear();
                listBox1.Items.Add("This ticket has no hut included.");
